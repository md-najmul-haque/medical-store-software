            ...
            <div className="modal modal-bottom sm:modal-middle">
                <div className="modal-box min-w-[50%] px-10 bg-white">
                    <div className='border-b-2'>
                        <label htmlFor="edit-category" className="btn btn-sm btn-ghost font-bold text-lg btn-square absolute right-8 top-5">✕</label>
                        <h1 className='uppercase text-left text-primary text-xl font-bold'>Update Category</h1>
                    </div>
                    ...
                    <form onSubmit={handleSubmit(onSubmit)}>
                        <div className=''>
                            ...
                            <div className="flex justify-center items-center mt-5">
                                <button onClick={() => setEditCategoryModal(false)} className="btn btn-secondary px-10 text-white mr-5">Close</button>
