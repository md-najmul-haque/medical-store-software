    ...
    return (
        ...
        <div className=''>
            <div className='py-3 px-5'>
                <h1 className='uppercase text-xl font-bold text-left text-primary'>Datewise Report</h1>
                <div className="text-sm breadcrumbs">
                    <ul>
                        <li><Link to='/dashboard'>Dashboard</Link></li>
                        <li><Link to='/dashboard/datewiseReport'>Datewise Report</Link></li>
                    </ul>
                </div>
            </div>
            ...
            <div className="bg-white mx-5 shadow-xl rounded-xl">
                ...
                <div className='flex justify-center item-center'>
                    <div className='text-center mt-5'>
                        <h1 className='text-2xl font-semibold'>Datewise Sale Report</h1>
